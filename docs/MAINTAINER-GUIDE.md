...
The current corrective candidate evidence is in [0.5.3 release candidate](RELEASE-CANDIDATE-0.5.3.md). Accept burn-in only through the opt-in [user-submitted reporting guide](BURN-IN.md); add no telemetry or background reporting.
