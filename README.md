...
The corrective 0.5.2 candidate and opt-in reporting boundaries are recorded in [release-candidate evidence](docs/RELEASE-CANDIDATE-0.5.2.md) and the [burn-in guide](docs/BURN-IN.md); neither document by itself represents publication.
