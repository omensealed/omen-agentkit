...
The local 0.5.0 candidate and opt-in reporting boundaries are recorded in [release-candidate evidence](docs/RELEASE-CANDIDATE-0.5.0.md) and the [burn-in guide](docs/BURN-IN.md); neither document represents publication.
